...
Were you looking for *any way* to get HDMI Output on your HX300 without any text or menu overlays?
...
On some cameras, like the A5000 (actually the only one I know), a clean HDMI output can also be achieved by writing a value to a specific memory address of the device. If this is not too much of a hastle for you, it may be a "more satisfying" solution? In case of my HX400V I have not found for certain to what adress I have to write, nor am I keen on digging that deep.
...
Most important thing for you to know: I am not an android developer, nor have I used Java professionally or otherwise (what I am proficient in is c/c++/python). It was already a struggle for me to compile the project and have a built apk that runs on the camera (although I surely made it more complicated to myself than it may be for android-devs).
...
* The build .apk resides in your projects app/build/outputs/apk/debug/app-debug.apk - you can install that with pmca-gui.
